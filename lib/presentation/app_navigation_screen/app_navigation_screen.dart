                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            _buildScreenTitle(
                              context,
                              screenTitle: "onboarding_1".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.onboarding1Screen),
                            ),
                            _buildScreenTitle(
                              context,
                              screenTitle: "onboarding_screen_2".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.onboardingScreen2Screen),
                            ),
                            _buildScreenTitle(
                              context,
                              screenTitle: "onboarding_screen_third".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.onboardingScreenThirdScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              screenTitle: "onboarding_screen_fourth".tr,
                              onTapScreenTitle: () => onTapScreenTitle(
                                  AppRoutes.onboardingScreenFourthScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              screenTitle: "setup_screen".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.setupScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              screenTitle: "dashboard_screen".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.dashboardScreen),
                            ),
                            _buildScreenTitle(
                              context,
                              screenTitle: "calander_screen".tr,
                              onTapScreenTitle: () =>
                                  onTapScreenTitle(AppRoutes.calanderScreen),
                            ),
                          ],
                        ),
                      ),
