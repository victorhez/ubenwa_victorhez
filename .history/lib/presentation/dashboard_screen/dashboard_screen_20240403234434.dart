import 'package:ubenwa_victorhez/presentation/dashboard_screen/widgets/suneight_item_widget.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // Allow SingleChildScrollView to expand infinitely
            ],
          ),
        ),
      ),
            ...
            child: BlocSelector<DashboardBloc, DashboardState, DashboardModel?>(
                ...
                builder: (context, dashboardModelObj) {
                  return ListView.separated(
                      ...
                      itemCount:
                          dashboardModelObj?.eightyeightItemList.length ?? 0,
        ...
        child: BlocSelector<DashboardBloc, DashboardState, DashboardModel?>(
            ...
            builder: (context, dashboardModelObj) {
              return ListView.separated(
                  ...
                  itemCount: dashboardModelObj?.ninetynineItemList.length ?? 0,
                  itemBuilder: (context, index) {
                    NinetynineItemModel model =
                        dashboardModelObj?.ninetynineItemList[0] ??
                            NinetynineItemModel();
                    return index==1?SunEightItemWidget() NinetynineItemWidget(model);
                  });
            }));
  }
