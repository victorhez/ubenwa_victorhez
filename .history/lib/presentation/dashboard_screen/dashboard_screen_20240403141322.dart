                        ...
                        ? Stack(
                            ...
                            children: [
                              Container(
                                  width: 38.h,
                                  padding:
                                      EdgeInsets.symmetric(vertical: 20.1.v),
                                  decoration: BoxDecoration(
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  Text("lbl_nov".tr, style: CustomTextStyles.bodyLargeGray500),
                  Padding(
                    padding: EdgeInsets.only(left: 3.h),
                    child: Text("lbl_aug".tr, style: CustomTextStyles.bodyLargeGray500)
                  )
                ]
              )
            ),
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: _buildTwentyEight(context, sun: "lbl_sat".tr, twentyThree: "lbl_22".tr)
                ),
                Padding(
                  padding: EdgeInsets.only(left: 9.h, top: 3.v, right: 9.h),
                  child: _buildTwentyEight(context, sun: "lbl_sun".tr, twentyThree: "lbl_23".tr)
                ),
                Padding(
                  padding: EdgeInsets.only(left: 9.h, bottom: 3.v),
                  child: _buildTwentyEight(context, sun: "lbl_mon".tr, twentyThree: "lbl_24".tr)
                )
              ]
            )
          ]
